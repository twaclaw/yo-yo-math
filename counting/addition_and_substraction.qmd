...
:::{.fun-fact title="The order doesn't matter"}
...
Other times, order doesn't matter, such as when adding up numbers.  For instance, did you notice that $3 + 2$ yields the same result as $2+3$? We can write that as:
...
We say that addition is **commutative**, meaning the order of the numbers being added does not matter.
