...
![](../static_images/legos/associativity/assoc1.svg){fig-align="center" width="30%"}
...
![](../static_images/legos/associativity/assoc2.svg){fig-align="center"}

We can use parentheses to indicate which numbers we should group together and add up first.

::: {.big-math}
$$
\underbrace{\underbrace{(\underbrace{(3+1)}_{3+1={\color{red}{4}}}+2)}_{{\color{red}{4}}+2={\color{blue}{6}}}+3}_{{\color{blue}{6}}+3={\color{green}{9}}} = \color{green}{9}
$$
:::
