...
An area is a measure of the size of a two-dimensional object. For example, the area of the wall below is equal to the number of LEGO bricks that make up the wall.

![](../static_images/legos/areas/6x8_green_front.svg){fig-align="center" width="80%"}

The total number of green bricks is [$6 \times 8 = 48$]{.scale factor="2"}. 
...
The total number of yellow bricks is [$3 \times 4 \times 2 = 24$]{.scale factor="2"}.
