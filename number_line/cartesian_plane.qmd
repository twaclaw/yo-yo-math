## Playing Battleship $\text{[pirate_flag:1.0em]{.twemoji}}$ $\text{[parrot:1.0em]{.twemoji}}$
...
| 2 | Plane/polygons | `<img src="../static_images/polygons/square_filled.svg" width="40"/>`{=html}`$\color{red}{\drawpolygon[red]{4}}$`{=latex} | We can move forward and backward, and also left and right.|
| 3 | Volumes | $\text{[game_die:4em]{.twemoji}}$ | We can move left, right, forward, backward, and jump up and down.|
